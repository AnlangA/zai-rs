...
use crate::client::v2::services::Services;
...
pub struct ZaiClientBuilder {
    api_key: String,
    endpoints: crate::client::v2::endpoint::EndpointConfigBuilder,
...
impl ZaiClientBuilder {
    ...
    pub fn endpoint(
        mut self,
        family: crate::client::v2::endpoint::ApiFamily,
        base: &'static str,
    ) -> Self {
        use crate::client::v2::endpoint::ApiFamily::*;
        match family {
