...
mod tests {
    ...
    fn test_video_quality_serialization() {
        assert_eq!(serde_json::to_string(&VideoQuality::Speed).unwrap(), r#""speed""#);
        assert_eq!(serde_json::to_string(&VideoQuality::Quality).unwrap(), r#""quality""#);
    }

    #[test]
    fn test_video_size_serialization() {
        assert_eq!(serde_json::to_string(&VideoSize::Size1920x1080).unwrap(), r#""1920x1080""#);
        assert_eq!(serde_json::to_string(&VideoSize::Size3840x2160).unwrap(), r#""3840x2160""#);
    }
    ...
    fn test_video_duration_serialization() {
        assert_eq!(serde_json::to_string(&VideoDuration::Duration5).unwrap(), r#""duration5""#);
        assert_eq!(serde_json::to_string(&VideoDuration::Duration10).unwrap(), r#""duration10""#);
    }
