...
impl RerankRequest {
    ...
    pub fn with_top_n(mut self, n: usize) -> Self { self.body = self.body.with_top_n(n); self }
    pub fn with_return_documents(mut self, v: bool) -> Self { self.body = self.body.with_return_documents(v); self }
    pub fn with_return_raw_scores(mut self, v: bool) -> Self { self.body = self.body.with_return_raw_scores(v); self }
...
impl HttpClient for RerankRequest {
    ...
    fn api_url(&self) -> &Self::ApiUrl { &"https://open.bigmodel.cn/api/paas/v4/rerank" }
